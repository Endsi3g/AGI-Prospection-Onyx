          ...
          <div className="flex items-center justify-between px-6 pt-6 pb-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                onClick={toggleSettings}
                prominence="tertiary"
                tooltip={t("settings.closeSettings")}
              />
            </div>
          </div>
        </div>
        ...
        <div className="px-6 pb-8 flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1 bg-background-tint-01 rounded-2xl px-4">
              <SettingRow label={t("settings.useOnyxAsNewTab")}>
                <Switch
          ...
          <section className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1 bg-background-tint-01 rounded-2xl px-4 py-2">
              <Text secondaryBody text03 className="mb-2">
                ...
                {SUPPORTED_LOCALES.map((loc) => (
                  <button
                    ...
                    className={cn(
                      ...
                      locale === loc.code
                        ? "bg-theme-primary-05 text-text-inverted-05 shadow-sm"
                        : "bg-background-neutral-02 text-text-03 hover:bg-background-neutral-03"
                    )}
                  >
                    <span className="text-lg">{loc.flag}</span>
                    <span>{loc.label}</span>
                    {locale === loc.code && (
                      <SvgCheck className="w-4 h-4 stroke-current" />
                    )}
                  </button>
                ))}
              </div>
