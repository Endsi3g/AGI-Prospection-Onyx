...
BUILT_IN_TOOLS = [
    ...
    # AGI Prospection Tools
    {
        "name": "ProspectScorerTool",
        "display_name": "Prospect ICP Scorer",
        "description": (
            "Score a prospect against the Ideal Customer Profile (ICP). "
            "Analyzes company size, decision-maker level, industry, and pain indicators "
            "to produce a 0-100 fit score with outreach strategy recommendations."
        ),
        "in_code_tool_id": "ProspectScorerTool",
    },
    {
        "name": "ObjectionHandlerTool",
        "display_name": "Objection Handler (Manuel d'Élite)",
        "description": (
            "Generate elite objection responses using Daniel G's 3-attempt framework. "
            "Handles financial, deflection, rejection, time, and competition objections "
            "with scripted responses and psychological analysis."
        ),
        "in_code_tool_id": "ObjectionHandlerTool",
    },
    {
        "name": "OutreachScriptTool",
        "display_name": "Outreach Script Generator",
        "description": (
            "Generate Cold Loom (Charlie Morgan), Cold Email (Aaron Shepherd), "
            "or Cold Call (Jordan Platten) scripts following elite sales methodologies."
        ),
        "in_code_tool_id": "OutreachScriptTool",
    },
    {
        "name": "DatasetIngestionTool",
        ...
        "in_code_tool_id": "DatasetIngestionTool",
    },
    {
        "name": "TelegramNotifierTool",
        "display_name": "Telegram Notifier",
        "description": (
            "Send real-time notifications to Telegram. Use for alerts about hot leads, "
            "completed outreach sequences, objection wins, or any important prospection event."
        ),
        "in_code_tool_id": "TelegramNotifierTool",
    },
    {
        "name": "TwilioOutreachTool",
        ...
        "in_code_tool_id": "TwilioOutreachTool",
    },
]
