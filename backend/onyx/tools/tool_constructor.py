...
from onyx.tools.tool_implementations.prospection.objection_handler_tool import (
    ObjectionHandlerTool,
)
from onyx.tools.tool_implementations.prospection.outreach_script_tool import (
    OutreachScriptTool,
)
from onyx.tools.tool_implementations.prospection.prospect_scorer_tool import (
    ProspectScorerTool,
)
from onyx.tools.tool_implementations.prospection.dataset_ingestion_tool import (
    DatasetIngestionTool,
)
from onyx.tools.tool_implementations.prospection.telegram_notifier_tool import (
    TelegramNotifierTool,
)
from onyx.tools.tool_implementations.prospection.twilio_outreach_tool import (
    TwilioOutreachTool,
)
...
def _construct_tools_impl(
    ...
    for db_tool_model in persona.tools:
        ...
        if db_tool_model.in_code_tool_id:
            ...
            # Handle AGI Prospection Tools
            elif tool_cls.__name__ == ProspectScorerTool.__name__:
                tool_dict[db_tool_model.id] = [
                    ProspectScorerTool(
                        tool_id=db_tool_model.id,
                        emitter=emitter,
            ...
            elif tool_cls.__name__ == ObjectionHandlerTool.__name__:
                tool_dict[db_tool_model.id] = [
                    ObjectionHandlerTool(
                        tool_id=db_tool_model.id,
                        emitter=emitter,
            ...
            elif tool_cls.__name__ == OutreachScriptTool.__name__:
                tool_dict[db_tool_model.id] = [
                    OutreachScriptTool(
                        tool_id=db_tool_model.id,
                        emitter=emitter,
            ...
            elif tool_cls.__name__ == DatasetIngestionTool.__name__:
                tool_dict[db_tool_model.id] = [
                    DatasetIngestionTool(
                        tool_id=db_tool_model.id,
                        emitter=emitter,
            ...
            elif tool_cls.__name__ == TelegramNotifierTool.__name__:
                tool_dict[db_tool_model.id] = [
                    TelegramNotifierTool(
                        tool_id=db_tool_model.id,
                        emitter=emitter,
            ...
            elif tool_cls.__name__ == TwilioOutreachTool.__name__:
                tool_dict[db_tool_model.id] = [
                    TwilioOutreachTool(
                        tool_id=db_tool_model.id,
                        emitter=emitter,
